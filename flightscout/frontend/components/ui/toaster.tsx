...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === 'destructive' ? 'border-red-200 bg-red-50 text-red-900' : 'border bg-background text-foreground',
      className
    )}
    {...props}
  />
...
// Simple self-contained toaster (no context required for basic use)
