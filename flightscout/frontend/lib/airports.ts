...
export const AIRPORTS: Airport[] = [
  ...
  { iata: 'BDL', name: 'Bradley International', city: 'Hartford', country: 'US', timezone: 'America/New_York', lat: 41.9385, lon: -72.6833 },
  { iata: 'PHL', name: 'Philadelphia International', city: 'Philadelphia', country: 'US', timezone: 'America/New_York', lat: 39.8716, lon: -75.2412 },
  { iata: 'DCA', name: 'Ronald Reagan Washington National', city: 'Washington', country: 'US', timezone: 'America/New_York', lat: 38.8521, lon: -77.0377 },
  { iata: 'IAD', name: 'Washington Dulles International', city: 'Washington', country: 'US', timezone: 'America/New_York', lat: 38.8951, lon: -77.4373 },
  { iata: 'SAN', name: 'San Diego International', city: 'San Diego', country: 'US', timezone: 'America/Los_Angeles', lat: 32.7333, lon: -117.1897 },
  { iata: 'BNA', name: 'Nashville International', city: 'Nashville', country: 'US', timezone: 'America/Chicago', lat: 36.1245, lon: -86.6782 },
  { iata: 'AUS', name: 'Austin-Bergstrom International', city: 'Austin', country: 'US', timezone: 'America/Chicago', lat: 30.3049, lon: -97.8891 },
  { iata: 'DAL', name: 'Dallas Love Field', city: 'Dallas', country: 'US', timezone: 'America/Chicago', lat: 32.8475, lon: -96.8514 },
  { iata: 'RDU', name: 'Raleigh-Durham International', city: 'Raleigh', country: 'US', timezone: 'America/New_York', lat: 35.8775, lon: -78.7875 },
  { iata: 'MCI', name: 'Kansas City International', city: 'Kansas City', country: 'US', timezone: 'America/Chicago', lat: 39.2976, lon: -94.7138 },
  // International
